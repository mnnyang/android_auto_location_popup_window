...
public class AutoLocationWindow {
    ...
    protected AutoLocationWindow() {
    }

    public static AutoLocationWindow with(Activity context) {
        AutoLocationWindow window = new AutoLocationWindow();
     ...
     * 强制显示位置
     */
    public AutoLocationWindow enforceLocation(int location) {
    ...
    private void autoLocation(int surplusHeight) {
